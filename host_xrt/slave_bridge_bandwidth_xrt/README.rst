...
This is slave bridge bandwidth example to describe host memory and kernel bandwidth test using native xrt api's.
...
::
   ...
   ./slave_bridge_bandwidth_xrt -x <bandwidth XCLBIN>
