...
int main(int argc, char **argv) {
  ...
  auto bo1 = xrt::bo(device, size_in_bytes, krnl_mmult.group_id(0));
  auto bo_dev_only = xrt::bo(device, size_in_bytes, flags, krnl_mmult.group_id(0));

  auto bo2 = xrt::bo(device, size_in_bytes, krnl_madd.group_id(0));
  auto bo_out = xrt::bo(device, size_in_bytes, krnl_madd.group_id(0));
