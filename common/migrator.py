...
os.system("mkdir -p host cpp_kernels rtl_kernels ocl_kernels applications sys_opt")
...
os.system(pwd + "/common/utility/makefile_gen/update_descgen_all.sh")
...
# Also we need to change the tcl scripts for rtl kernels based on Scout
# requirements.
