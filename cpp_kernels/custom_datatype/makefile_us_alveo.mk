...
LINK_OUTPUT := $(BUILD_DIR)/rgb_to_hsv.link.xclbin
...
all: check-platform check-device check-vitis $(EXECUTABLE) $(BUILD_DIR)/rgb_to_hsv.xclbin emconfig
...
$(BUILD_DIR)/rgb_to_hsv.xclbin: $(TEMP_DIR)/rgb_to_hsv.xo
	...
	v++ -p $(LINK_OUTPUT) $(VPP_FLAGS) -t $(TARGET) --platform $(PLATFORM) --package.out_dir $(PACKAGE_OUT) -o $(BUILD_DIR)/rgb_to_hsv.xclbin
