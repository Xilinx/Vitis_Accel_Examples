...
PLATFORM_BLOCKLIST += zc vck u30 u50 u55 samsung u2_ x3522pv nodma v70 
...
$(BUILD_DIR)/apply_watermark.xclbin: $(TEMP_DIR)/apply_watermark.xo
	mkdir -p $(BUILD_DIR)
	v++ $(VPP_FLAGS) -l $(VPP_LDFLAGS) --temp_dir $(TEMP_DIR) $(VPP_LDFLAGS_apply_watermark) -o'$(LINK_OUTPUT)' $(+)
	v++ -p $(LINK_OUTPUT) $(VPP_FLAGS) --package.out_dir $(PACKAGE_OUT) -o $(BUILD_DIR)/apply_watermark.xclbin
