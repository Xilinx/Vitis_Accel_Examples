...
PLATFORM_BLOCKLIST += u25_ u30 zc vck u50 u55 samsung u2_ x3522pv nodma v70 
...
# Kernel linker flags
VPP_LDFLAGS_mmult += --config ./mmult.cfg
EXECUTABLE = ./plram_access
...
$(BUILD_DIR)/mmult.xclbin: $(TEMP_DIR)/mmult.xo
	mkdir -p $(BUILD_DIR)
	v++ -l $(VPP_FLAGS) $(VPP_LDFLAGS) -t $(TARGET) --platform $(PLATFORM) --temp_dir $(TEMP_DIR) $(VPP_LDFLAGS_mmult) -o'$(LINK_OUTPUT)' $(+)
