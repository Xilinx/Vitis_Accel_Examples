...
LINK_OUTPUT := $(BUILD_DIR)/apply_watermark_GOOD.link.xclbin
...
all: check-platform check-device check-vitis $(EXECUTABLE) $(BUILD_DIR)/apply_watermark_GOOD.xclbin emconfig
...
$(BUILD_DIR)/apply_watermark_GOOD.xclbin: $(TEMP_DIR)/apply_watermark.xo
	...
	v++ -p $(LINK_OUTPUT) $(VPP_FLAGS) -t $(TARGET) --platform $(PLATFORM) --package.out_dir $(PACKAGE_OUT) -o $(BUILD_DIR)/apply_watermark_GOOD.xclbin
