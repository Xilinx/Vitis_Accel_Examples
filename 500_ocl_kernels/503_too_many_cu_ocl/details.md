Clock Frequency ~ Too Many Compute Units (CL) 
======================
...
```
./host ./xclbin/vadd_GOOD.<emulation target>.<device name>.xclbin ./xclbin/vadd_BAD.<emulation target>.<device name>.xclbin
```
