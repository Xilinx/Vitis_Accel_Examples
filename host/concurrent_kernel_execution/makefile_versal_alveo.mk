...
all: check-platform check-device check-vitis $(EXECUTABLE) $(BUILD_DIR)/matrix_ops.xclbin emconfig
...
$(BUILD_DIR)/matrix_ops.xclbin: $(TEMP_DIR)/madd.xo $(TEMP_DIR)/mscale.xo $(TEMP_DIR)/mmult.xo
	...
	v++ -p $(LINK_OUTPUT) $(VPP_FLAGS) -t $(TARGET) --platform $(PLATFORM) --package.out_dir $(PACKAGE_OUT) -o $(BUILD_DIR)/matrix_ops.xclbin
