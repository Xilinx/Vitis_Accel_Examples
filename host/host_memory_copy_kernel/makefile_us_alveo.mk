...
PLATFORM_BLOCKLIST += u25_ u30 u50lv u50_gen3x4 zc vck 2019 2018 u2_ v70 
...
VPP_LDFLAGS += --config ./connectivity.cfg
endif
ifeq ($(findstring u50, $(PLATFORM)), u50)
VPP_LDFLAGS += --config ./connectivity.cfg
endif
EXECUTABLE = ./host_memory_copy_kernel.exe
...
$(TEMP_DIR)/copy_kernel.xo: src/copy_kernel.cpp
	mkdir -p $(TEMP_DIR)
	v++ -c $(VPP_FLAGS) -t $(TARGET) --platform $(PLATFORM) -k copy_kernel --temp_dir $(TEMP_DIR)  -I'$(<D)' -o'$@' '$<'
