...
void pkt2struct(hls::stream<RGBcolor>& read_stream, hls::stream<pkt>& in, hls::stream<bool> eos[2]) {
...
void compute_dataflow(hls::stream<HSVcolor>& write_stream, hls::stream<RGBcolor>& read_stream, hls::stream<bool>& eos) {
    bool t_last;
    RGBcolor rgb;
    HSVcolor hsv;
...
void struct2pkt(hls::stream<pkt>& out, hls::stream<HSVcolor>& write_stream, hls::stream<bool>& eos) {
    bool t_last;
