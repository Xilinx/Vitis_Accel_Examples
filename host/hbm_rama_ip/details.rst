...
``postSysLink.tcl`` file has been added to the Makefile.
...
::
   ...
   OVERALL THROUGHPUT = 97.0091 GB/s
   CHANNEL THROUGHPUT = 12.1261 GB/s
   TEST PASSED

By default we are going with 2 compute units of kernel as we have power
