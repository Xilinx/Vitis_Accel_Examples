...
$(LINK_OUTPUT): $(TEMP_DIR)/mem_read_func.xo $(TEMP_DIR)/increment_func.xo $(TEMP_DIR)/mem_write_func.xo $(TEMP_DIR)/mem_read_rtl.xo $(TEMP_DIR)/increment_rtl.xo $(TEMP_DIR)/mem_write_rtl.xo
	mkdir -p $(BUILD_DIR)
