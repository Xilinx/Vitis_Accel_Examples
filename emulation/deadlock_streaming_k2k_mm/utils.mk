...
COMMON_REPO ?= $(shell bash -c 'export MK_PATH=$(MK_PATH); echo $${MK_PATH%emulation/deadlock_streaming_k2k_mm/*}')
...
ifeq ($(TARGET),$(filter $(TARGET),sw_emu hw_emu))
	...
	$(ECHO) 'cd -' >> run_app.sh
	$(ECHO) '$(EXECUTABLE) krnl_stream_vadd_vmult.xclbin' >> run_app.sh
	$(ECHO) 'return_code=$$?' >> run_app.sh
