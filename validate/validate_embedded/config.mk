...
ifeq ($(findstring zcu102_base_dfx, $(DEVICE)), zcu102_base_dfx)
...
else ifeq ($(findstring zcu102_base, $(DEVICE)), zcu102_base)
...
else ifeq ($(findstring zcu104_base, $(DEVICE)), zcu104_base)
...
else ifeq ($(findstring vck190, $(DEVICE)), vck190)
