...
void plController::enqueue_set_aie_iteration(const std::string& graphName, int num_iter, int ctrl_nm) {
...
void plController::enqueue_sync() {
...
void plController::enqueue_set_and_enqueue_dma_bd(const std::string& portName, int idx, int dma_bd_len, int id) {
...
void plController::enqueue_update_aie_rtp(const std::string& rtpPort, int rtpVal, int id) {
