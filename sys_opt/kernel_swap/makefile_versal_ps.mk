...
ifeq ($(EMU_PS), X86)
	v++ -p $(LINK_OUTPUT_VMUL) $(VPP_FLAGS) --package.emu_ps x86 -o $(BUILD_DIR)/krnl_vmul.xclbin    
endif
$(BUILD_DIR)/krnl_vadd.xclbin: $(TEMP_DIR)/krnl_vadd.xo
	mkdir -p $(BUILD_DIR)
	v++ $(VPP_FLAGS) -l $(VPP_LDFLAGS) --temp_dir $(TEMP_DIR) -o'$(LINK_OUTPUT_VADD)' $(+)
ifeq ($(EMU_PS), X86)
	v++ -p $(LINK_OUTPUT_VADD) $(VPP_FLAGS) --package.emu_ps x86 -o $(BUILD_DIR)/krnl_vadd.xclbin
endif
