...
/**
 * @file zlib_dm_rd.hpp
 * @brief Header for zlib data reader kernel which reads data from zlib
...
extern "C" {
/**
 * @brief Zlib data mover:reader kernel top function. It reads data from zlib
 * decompression kernel stream interface
 ...
 * @param outstreamk output axi kernel stream (512-bit wide data stream read by
 * this kernel)
 * @param sizestreamk output data size axi kernel stream (size valid in 512-bits
 * read by this kernel)
 *
 */
